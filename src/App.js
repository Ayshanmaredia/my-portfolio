...
function App() {
  ...
  const projects = [{
    ...
    "description": "MovieDB is a platform to know about your favourite movies. It fetches information from API. You can get the list of popular, top rated and upcoming movies. From this project I learned about search functionality with the concept of debouncing and data context. The website is hosted on Netlify and is also compatible for mobile and tablet devices.",
  ...
  },
  {
    ...
    "name": "Listicle",
    "language": "React, JavaScript, React Bootstrap",
    "description": "Listicle Board is a website where you can manage your list of items, create a group list and invite your friends to the group. I have used Elastic email SMTP to send the group invitation to the user. The application uses JWT token for login/register functionality and is connected to the back-end. You can create, update and delete the list or group anytime you want.",
